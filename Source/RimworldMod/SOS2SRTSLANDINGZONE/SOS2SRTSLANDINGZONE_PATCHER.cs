...
namespace SOS2SRTSLANDINGZONE
{
    ...
    public class SOS2SRTSLANDINGZONE_PATCHER
    {
        ...
        {
            Log.Message("Initiating SRTS landing zone....");
    ...
    [HarmonyPatch(typeof(CompLaunchableSRTS), "StartChoosingDestination")]
    public static class SrtsStartPatch
    {
        public static CompLaunchableSRTS instance;
        public static Caravan carr;

        public static bool Prefix(CompLaunchableSRTS __instance, Caravan ___carr)
        {
            instance = __instance;
    ...
    [HarmonyPatch(typeof(CompLaunchableSRTS), "WorldStartChoosingDestination")]
    public static class SrtsWorldPatch
    {
        public static GlobalTargetInfo target;
        public static CompLaunchableSRTS instance;
        public static Caravan carr;

        public static bool Prefix(Caravan car, CompLaunchableSRTS __instance, ref Caravan ___carr)
        {
            instance = __instance;
